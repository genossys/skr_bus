                        ...
                        <div class="row">
                            ...
                            <div class="bootstrap-timepicker">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="jamKeberangkatan" data-target-input="nearest">
                                        <input value="08:00:00" type="text" class="form-control datetimepicker-input" data-toggle="datetimepicker" data-target="#jamKeberangkatan" id="jam" name="jam" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="harga" id="harga" aria-describedby="helpId" placeholder="" value="0">
                                </div>
                            </div>
