            ...
            <div class="col-md-11">
                <div class="text-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Form Tambah Kota</li>
                    </ol>
                </div>
                ...
                <div class="card card-outline card-info">
                    ...
                    <form method="post" action="/admin/kota/add">
                    <div class="card-body">
                         {{ csrf_field() }}
                         <div class="row">
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control @error('kdKota') is-invalid @enderror" placeholder="Kode Kota" id="kdKota" name="kdKota" value="{{ old('kdKota')}}">
                                        @error('kdKota')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control @error('namaKota') is-invalid @enderror" placeholder="Nama Kota" id="namaKota" name="namaKota" value="{{ old('namaKota')}}">
                                        @error('namaKota')
                                            <span class="msg invalid-feedback" role="alert">
                                                {{$message}}
                                            </span>
