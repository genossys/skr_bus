            ...
            <div class="col-md-11">
                <div class="text-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Form Tambah Terminal</li>
                    </ol>
                </div>
                ...
                <div class="card card-outline card-info">
                    ...
                    <form method="post" action="/admin/terminal/add">
                    <div class="card-body">
                         {{ csrf_field() }}
                         <div class="row">
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control @error('kdTerminal') is-invalid @enderror" placeholder="Kode Terminal" id="kdTerminal" name="kdTerminal" value="{{ old('kdTerminal')}}">
                                        @error('kdTerminal')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control @error('namaTerminal') is-invalid @enderror" placeholder="Nama Kota" id="namaTerminal" name="namaTerminal" value="{{ old('namaTerminal')}}">
                                        @error('namaTerminal')
                                            <span class="msg invalid-feedback" role="alert">
                                                {{$message}}
                                            </span>
                                    ...
                                    <label>Kota</label>
                                        <select class="form-control select2" style="width: 100%;" name="kdKota" id="kdKota">
                                                @foreach ($kota as $item)
                                                    <option value={{$item->kdKota}}>{{$item->namaKota}}</option>
                                                @endforeach
                                        </select>
                                </div>
                             </div>
